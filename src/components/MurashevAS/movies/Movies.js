...
const ColCardBox = ({
  Title, imdbID, Poster, Type, ShowDetail, DetailRequest, ActivateModal,
}) => {
  const clickHandler = () => {
...
const MovieDetail = ({
  Title, Poster, imdbRating, Rated, Runtime, Genre, Plot,
}) => (
  <Row>
    <Col span={11}>
      <img
      ...
      <Layout className="layout">
        <Header>
          <div style={{ textAlign: 'center' }}>
            <TextTitle style={{ color: '#ffffff', marginTop: '14px' }} level={3}>Поиск фильма по названию</TextTitle>
          </div>
        </Header>
