...
class SimonSays extends Component {
  ...
  onReset() {
	  this.setState({
	    score: 0, sequence: [], guesses: [], css: [], title: 'Rametta', on: true,
	  });
  }
  ...
  renderPanels() {
	  ...
	  return pans.map((panel, i) => {
	    ...
	    return <use key={i} className={css} href="#panel" onClick={() => this.panelClick(i)} />;
	  });
  }
  ...
  <svg className="simon" viewBox="0 0 1280 850">
    ...
    <path className="control-panel" d="M729.42003,389.999999 C733.667892,400.844403 736,412.649855 736,425 C736,478.019336 693.019336,521 640,521 C586.980664,521 544,478.019336 544,425 C544,412.649855 546.332108,400.844403 550.57997,389.999999 L729.420038,390 Z" />
    ...
    <circle id="btn-yellow" cx="374" cy="436" onClick={() => this.onSound()} />
    <circle id="btn-red" cx="430" cy="436" onClick={() => this.onReset()} />
    <circle id="btn-blue" cx="486" cy="436" onClick={() => this.onStart()} />
    <rect className="scoreboard" x="379" y="463" />
